...
// Custom "Heya!" effect component
function AppleHeyaEffect({
  className,
  speed = 1,
  onAnimationComplete,
  ...props
  ...
  return (
    ...
    >
      ...
      {/* h1 */}
      <motion.path
        d="M9.8125,-72.90625 L19.671875,-72.90625 L19.671875,-43.015625 L55.515625,-43.015625 L55.515625,-72.90625 L65.375,-72.90625 L65.375,-0.0 L55.515625,-0.0 L55.515625,-34.71875 L19.671875,-34.71875 L19.671875,-0.0 L9.8125,-0.0 L9.8125,-72.90625 Z M131.3984375,-29.59375 L131.3984375,-25.203125 L90.0859375,-25.203125 L90.30322265625,-22.951904296875 L91.15087890625,-18.864013671875 L92.54931640625,-15.328857421875 L94.49853515625,-12.346435546875 L95.6796875,-11.0625 L96.9912109375,-9.923583984375 L99...."
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* h2, e */}
      <motion.path
        d="M55.1624 181.135C60.6251 133.114 81.4118 98.0479 107.963 98.0479C123.844 98.0479 133.937 110.703 131.071 128.817C129.457 139.487 127.587 150.405 125.408 163.06C122.869 178.941 130.128 191.348 152.122 191.348C184.197 191.348 219.189 173.523 237.097 145.915C243.198 136.509 245.68 128.073 245.928 119.884C246.176 104.996 237.739 93.8296 222.851 93.8296C203.992 93.8296 189.6 115.17 189.6 142.465C189.6 171.745 205.481 192.341 239.208 192.341"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(0.7),
          opacity: { duration: 0.6, delay: calc(0.7) },
        }}
      />

      {/* y */}
      <motion.path
        d="M285.066 95.341C275.86 137.292 259.199 175.8585C252.788 188.513 246.275 192.4065 236.275 191.1512C226.26 189.8057 222.042 177.55823 230.131 167.55823C238.469 157.55823 252.777 156.6141 265.829 160.9129C277.688 164.4967 281.667 171.4162 279.203 178.4549"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* a */}
      <motion.path
        d="M320.871 112.995C315.007 101.8 304.666 94.2423 288.207 94.2423C260.912 94.2423 240.398 121.538 239.052 150.818C237.878 177.617 250.244 192.681 267.857 192.505C292.858 192.255 311.234 167.699 319.437 115.742C320.449 109.332 321.498 102.638 322.51 96.2274"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* ! */}
      <motion.path
        d="M380.51 96.2274C378.486 112.73 376.461 129.232 374.436 145.735C372.955 159.175 371.887 170.395 372.109 177.729M372.109 185.729C372.109 189.729 375.109 192.729 379.109 192.729C383.109 192.729 386.109 189.729 386.109 185.729C386.109 181.729 383.109 178.729 379.109 178.729C375.109 178.729 372.109 181.729 372.109 185.729Z"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeOut",
          delay: calc(3.4),
          opacity: { duration: 0.3, delay: calc(3.4) },
        }}
        onAnimationComplete={onAnimationComplete}
      />
    </motion.svg>
...
export { AppleHelloEnglishEffect, AppleHelloVietnameseEffect, AppleHeyaEffect };
